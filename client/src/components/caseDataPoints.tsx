              ...
              {Object.entries(metadata)
                ...
                .map(([key, value]) => {
                  if (key === "split_during_preprocessing") {
                    ...
                    return (
                      <div key={key} className="grid grid-rows-2 items-center ">
                        <Label
                          htmlFor={key}
                    ...
                    >
                      ...
                      <Textarea
                        readOnly={[
                          ...
                          "file_path",
                          "case_id",
                        ].includes(key as keyof ImageMetadata)}
                        value={value as string}
                        onChange={(e) => {
                          if (key === "file") {
            ...
            <div className="flex gap-2 items-center">
              ...
              <div className="flex gap-2">
                ...
                <Checkbox
                  ...
                  onCheckedChange={(e) =>
                    updateSelectedCase(metadata.file, "verified", e as string)
                  }
                />
              </div>
            </div>
        ...
        selectedCase[currentIndex] && (
          <div className="w-full h-full flex flex-col items-center gap-4">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <Button
                onClick={handleNext}
                disabled={currentIndex === selectedCase.length - 1}
                variant="secondary"
              >
                Next
              </Button>
            ...
            <CardFooter className="w-full max-w-2xl flex justify-end gap-2">
              ...
              <Button onClick={() => updateMetadata(selectedCase)}>Save</Button>
            </CardFooter>
          </div>
        )}
    </>
